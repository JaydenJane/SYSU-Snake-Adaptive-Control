...
\title{\huge{Multi-parameter regression control of snake-like robots by experience-based learning}}
...
\author{\IEEEauthorblockN{
	...
	Jianping Huang\IEEEauthorrefmark{1}
	Yuhong Huang\IEEEauthorrefmark{2},
	Linlin Liu\IEEEauthorrefmark{1},
	Long Cheng\IEEEauthorrefmark{1} and
...
%\IEEEauthorblockA{\IEEEauthorrefmark{1}Email: huangjp25@mail2.sysu.edu.cn}
...
%\IEEEauthorblockA{\IEEEauthorrefmark{1}Email: chengl@in.tum.de}
